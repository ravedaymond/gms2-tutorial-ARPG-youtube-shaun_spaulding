...
function EnemySlimeDie(){
	...
	// Current image_index + (15fps) / (60fps) = 0.25 frames per game step. Once animation is passed final image_number, destroy instance.
	if(image_index + (sprite_get_speed(sprite_index) / game_get_speed(gamespeed_fps)) >= image_number) instance_destroy();
}